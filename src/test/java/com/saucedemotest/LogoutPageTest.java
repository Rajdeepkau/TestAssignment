...
public class LogoutPageTest extends BaseTest {
	...
	public void validateLogoutFunctionality() {
		productsPage = loginPage.clickLoginButton(properties.getProperty("username"),properties.getProperty("password"));
		...
		productsPage = checkoutCompletePage.clickOnBackHome();
		loginPage = productsPage.clickOnlogout();
		softAssert.assertTrue(loginPage.isButtonDisplayed(), "Logout failed. Login button not displayed.");
